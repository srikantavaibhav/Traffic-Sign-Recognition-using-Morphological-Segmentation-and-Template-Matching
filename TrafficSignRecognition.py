...
def findTrafficSign():
	...
	if largestArea > frameArea*0.02:
            ...
            # output the description of the sign
            if detectedTrafficSign != None:
            	print("---> Recognized as: ",detectedTrafficSign)
            else: print("---> Traffic Sign not Recognized")	
...
def identifyTrafficSign(image):
    ...
    # each signs on the image.These define clusters.
    SIGNS_LOOKUP = {
    ...
    # centroid of each cluster can be computed from the above binary segments using weights.
